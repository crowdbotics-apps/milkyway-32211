  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_24_233}>
        <Text style={styles.Text_24_233}>Terms &amp; Conditions</Text>
      </View>
      <View style={styles.View_24_234}>
        <Text style={styles.Text_24_234}>
      ...
      <View style={styles.View_27_439}>
        <View style={styles.View_27_440}>
          <TouchableOpacity
            ...
            style={styles.TouchableOpacity_27_441}
            onPress={() =>
          ...
          <ImageBackground
            ...
            style={styles.ImageBackground_27_445}
          />
          <View style={styles.View_27_446}>
            <Text style={styles.Text_27_446}>Address</Text>
          </View>
        </View>
        <TouchableOpacity
          source={{
          ...
          style={styles.TouchableOpacity_27_447}
          onPress={() =>
